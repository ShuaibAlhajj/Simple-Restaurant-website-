document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        // Initialize the counter on load (handles autocomplete or page refresh state)
        updateCharCounter();

        // Listen for input to update the counter
        if (messageInput) {
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (isValid) {
                ...
                setTimeout(() => {
                    ...
                    form.reset();
                    updateCharCounter(); // Reset visual counter on form reset
